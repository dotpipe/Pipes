...
window.addEventListener("click", function(ev) {
	...
	if (elem.getAttribute("thru-pipe") == undefined || elem.getAttribute("thru-pipe") == null) {
		if (elem.getAttribute("to-pipe") !== undefined && elem.getAttribute("thru-pipe") !== null)
			window.location.replace(elem.getAttribute("to-pipe"));
		return;
	}
	if (elem.getAttribute("href") !== undefined && elem.getAttribute("href") !== null)
	...
	fetch(opts_req, opts);
	opts.clear();
	if (elem.getAttribute("to-pipe") !== undefined && elem.getAttribute("to-pipe") !==null)
		window.location.replace(elem.getAttribute("to-pipe"));
});